...
2.  On the **Create virtual network** blade, enter the following information:
    ...
    -  Region: **(US) East US** (Make sure this is **NOT** the same location you have specified in the previous exercises.)
     ...
     ![This represents the configuration of Creating an on-premises Virtual Network.](images/ecn18.png "Create virtual network")
...
![This represents the configuration of Creating an on-premises Virtual Network.](images/ecn20.png "Create virtual network")
...
7.  Upon completion, it should look like the following screenshot. Validate the information is correct, and select **Create**.
